...
<template>
  <div id="Sec3-Text0">
    ...
    <p class="leftP">
      ...
      響の拡大」が<ref>60.7％</ref>で突出して高かった（複数回答3 つまで、以下同）。次いで、「所得（減少）」
      （<ref>22.7％</ref>）や「米国経済」(<ref>22.5％</ref>）のほか、「雇用(悪化)」（<ref>21.2％</ref>）や「中国経済」（<ref>14.3％</ref>）、
      インバウンド需要を大きく左右する「訪日観光客数の減少」（<ref>10.2％</ref>）といった、海外経済と関連
      する項目が続いた。また、2019 年まで
      多くの企業が懸念材料に挙げていた
      「人手不足」は、<ref>12.8％</ref>と<claim>大幅に減少し
      ており</claim>、新型コロナによる業務量の減
      少などの影響を受け、変化が表れてい
      た様子がうかがえる。
    </p>
    <p>
