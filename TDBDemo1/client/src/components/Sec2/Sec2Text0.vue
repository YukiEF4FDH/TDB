...
<template>
  <div id="Sec2-Text0">
    ...
    <p class="leftP">
      『マイナスの影響がある』割合を業界別にみると、<claim>9業界中6業界（運輸・倉庫、金融、製造、不動産、小売、サービス）で10月を下回った</claim>。特に、<claim>
			『製造』『サービス』では3カ月連続で減少しており</claim>、マイナスの影響は僅かながらも緩和している。しかし、<claim>6月以降5カ月ぶりに全業界で8割を超える</claim>など、依然として
		<claim>
    ...
    <p class="leftP">
      ...
      <claim>9 業界中 6 業界( 小売、 金融、 製造、 サービス、 不動産、 運輸・倉庫) では 10 月を上回り</claim> 、飲食料品を取り扱う業種が上位に並んだ。
      しかし、 <claim>『卸売』『建設』のように 10 月を下回る</claim>業界もある など、 プラスの影響は一部の企業にとどまり、依然として<claim>大半の企業が業績にマイナスの影響を受けている</claim>。
    </p>
  </div>
</template>
